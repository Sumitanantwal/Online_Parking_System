...
let searchbox2 = document.getElementById('myTable2');
const existprelocal3 = JSON.parse(localStorage.getItem("prebook3")) || [];
for(let i=0;i<existprelocal3.length;i++){
    let tr = document.createElement("tr");
	searchbox2.appendChild(tr);

    let td0 = document.createElement("td");
	td0.innerHTML = i+1;
    tr.appendChild(td0);
    let td1 = document.createElement("td");
	td1.innerHTML = existprelocal3[i].date;
	tr.appendChild(td1);
    let td2 = document.createElement("td");
	td2.innerHTML = existprelocal3[i].name;
	tr.appendChild(td2);
    let td3 = document.createElement("td");
	td3.innerHTML = existprelocal3[i].place;
	tr.appendChild(td3);
    let td31 = document.createElement("td");
	td31.innerHTML = existprelocal3[i].contact;
	tr.appendChild(td31);
    let td4 = document.createElement("td");
	td4.innerHTML = existprelocal3[i].type;
	tr.appendChild(td4);
    let td5 = document.createElement("td");
	td5.innerHTML = existprelocal3[i].plate;
	tr.appendChild(td5);
    let td6 = document.createElement("td");
	td6.innerHTML = existprelocal3[i].arrival+":00";
	tr.appendChild(td6);
    let td7 = document.createElement("td");
	td7.innerHTML = existprelocal3[i].depart+":00";
	tr.appendChild(td7);
    let td8 = document.createElement("td");
	td8.innerHTML = existprelocal3[i].amount;
	tr.appendChild(td8);
    let td9 = document.createElement("td");
    let payimg = document.createElement("img");
    payimg.src = existprelocal3[i].url;
    payimg.style.width="50px";
    payimg.style.padding="10px";
	td9.appendChild(payimg);
	tr.appendChild(td9);
